...
import 'package:expense_tracker/views/screens/model/fetch_category.dart';
...
class HomePageController extends GetxController {
  ...
  List<CategoryData> allCategory = [
    CategoryData(
        ...
        categoryImage: "assets/icons/education.png",
        isSelect: false),
    CategoryData(
        categoryName: "Food",
        categoryImage: "assets/icons/fast_food.png",
        isSelect: false),
    CategoryData(
        categoryName: "Business",
        categoryImage: "assets/icons/businessman.png",
        isSelect: false),
    CategoryData(
        categoryName: "Recharge",
        categoryImage: "assets/icons/mobile_app.png",
        isSelect: false),
    CategoryData(
        categoryName: "Shopping",
        categoryImage: "assets/icons/grocery_cart.png",
        isSelect: false),
    CategoryData(
        categoryName: "Loan",
        categoryImage: "assets/icons/signing.png",
        isSelect: false),
    CategoryData(
        categoryName: "Travelling",
        categoryImage: "assets/icons/travel.png",
        isSelect: false),
    CategoryData(
        categoryName: "Salary",
        categoryImage: "assets/icons/calendar.png",
        isSelect: false),
    CategoryData(
        categoryName: "House Rent",
        categoryImage: "assets/icons/house.png",
        isSelect: false),
    CategoryData(
        categoryName: "Hospital",
        categoryImage: "assets/icons/first_aid_kit.png",
        isSelect: false),
    CategoryData(
        categoryName: "Light Bill",
        categoryImage: "assets/icons/idea.png",
        isSelect: false),
  ];
